...
class Battleship:
    ...
    def computer_guess(self):
        computer_x_row, computer_y_column = random.randint(0, 7), random.randint(0, 7)
        return computer_x_row, computer_y_column
...
def run_game():
    ...
    while turns > 0:
        ...
        if Battleship(user_guess_board.board).count_hit_ships() == 5:
            ...
            # Computer's turn
            computer_x_row, computer_y_column = Battleship.computer_guess()
            print(f"Computer guesses: {chr(computer_y_column + 65)}{computer_x_row + 1}")

            if user_guess_board.board[computer_x_row][computer_y_column] == "X":
                print("Computer sunk one of your battleships!")
            ...
            if Battleship(user_guess_board.board).count_hit_ships() == 5:
                print("Computer hit all 5 battleships!")
                break
